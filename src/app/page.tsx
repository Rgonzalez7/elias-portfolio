    ...
    <main className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <section id="top" className="mx-auto max-w-5xl px-5 pt-16 pb-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-zinc-600 dark:text-zinc-300">
            ...
            Currently building{" "}
            <span className="text-zinc-900 font-medium dark:text-white">Guibbo</span>, an AI-driven
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <div className="ml-1 flex items-center gap-4 text-sm text-zinc-600 dark:text-zinc-300">
              <a
              ...
              <a className="hover:text-zinc-900 dark:hover:text-white" href="mailto:rmngzps@gmail.com">
                Email
              </a>
            </div>
          </div>
      ...
      <section id="projects" className="mx-auto max-w-5xl px-5 py-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {/* Featured: Guibbo */}
          <article className="rounded-2xl border border-zinc-200 p-6 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <section id="about" className="mx-auto max-w-5xl px-5 py-12">
        ...
        <div className="mt-4 max-w-3xl space-y-4 text-zinc-600 dark:text-zinc-300">
          <p>
          ...
          <p className="text-sm">
            <span className="text-zinc-900 font-medium dark:text-white">Core stack:</span>{" "}
      ...
      <section id="contact" className="mx-auto max-w-5xl px-5 py-12">
        ...
        <footer className="mt-10 pb-10 text-sm text-zinc-500 dark:text-zinc-400">
          © {year} Elias Gonzalez
        </footer>
      </section>
    </main>
