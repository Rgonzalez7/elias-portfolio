    ...
    <main className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100 transition-colors duration-300">
      ...
      >
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {/* Desktop nav */}
            <nav className="hidden sm:flex items-center gap-5 text-sm text-zinc-600 dark:text-zinc-300">
              <a
      ...
      <section id="top" className="mx-auto max-w-5xl px-5 pt-20 pb-14">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-zinc-600 dark:text-zinc-300 transition-colors duration-300">
            Full-stack engineer building scalable apps and practical AI tooling—focused on speed, clarity, and product execution.
          </p>

          {/* Buttons (mobile ultra fine) */}
          <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <div className="mt-2 sm:mt-0 sm:ml-1 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-zinc-600 dark:text-zinc-300 transition-colors duration-300">
              <a
                className="transition-colors duration-200 hover:text-zinc-900 dark:hover:text-white"
          ...
          {[
            {
              ...
              desc: "Lightweight tool that analyzes session text and generates structured feedback.",
              tags: ["Next.js", "API Integrations"],
            },
            {
              title: "Dashboard UI Kit",
              desc: "Reusable dashboard components built with a minimal design system.",
              tags: ["React", "Tailwind"],
            },
            {
              title: "Auth + API Starter",
              desc: "Clean full-stack starter with authentication, protected routes, and REST endpoints.",
              tags: ["Node.js", "MongoDB", "REST"],
            },
          ].map((p) => (
            <article
              key={p.title}
              className="rounded-2xl border border-zinc-200 p-7 sm:p-6 dark:border-zinc-800
                         transition-transform duration-200 will-change-transform
                         hover:-translate-y-[2px]
                         hover:shadow-[0_12px_30px_-18px_rgba(0,0,0,0.35)]
                         dark:hover:shadow-[0_12px_30px_-18px_rgba(0,0,0,0.7)]"
